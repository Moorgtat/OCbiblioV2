...
//                "Haruki Murakami","/static/Covers/Kafka-sur-le-rivage.jpg", 2, 2));
...
//                "Tom Wolfe","/static/Covers/Le-bucher-des-vanites.jpg", 1, 1));
...
//                "Stefan Zweig","/static/Covers/Le-monde-d'hier.jpg", 2, 2));
...
//                "John Irving","/static/Covers/L'épopée-du-buveur-d'eau.jpg", 2, 2));
...
//                "J.D Salinger","/static/Covers/L'attrape-coeur.jpg", 2, 2));
...
//                "George Semprun","/static/Covers/Le-grand-voyage.jpg", 1, 1));
...
//                "Patrick Süskind","/static/Covers/Le-parfum.jpg", 1, 1));
...
//                "Ira Levin","/static/Covers/Un-bonheur-insoutenable.jpg", 1, 1));
...
//                "Jack Vance","/static/Covers/Le-cycle-de-Tschaï.jpg", 2, 2));
...
//                "James Ellroy","/static/Covers/Le-dahlia-noir.jpg", 2, 2));
...
//                "Alexandre Clérisse","/static/Covers/L-été-diabolik.jpg", 2, 2));
