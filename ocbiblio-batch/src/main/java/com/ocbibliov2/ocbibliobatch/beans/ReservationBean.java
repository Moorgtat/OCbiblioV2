...
public class ReservationBean {
    ...
    private Collection<uReservationBean> fileReservation;
    ...
    public ReservationBean(@Size(min = 1, max = 50) String nomLivre, Boolean isFileResEmpty, int BQtMax) {
    ...
    public Collection<uReservationBean> getFileReservation() {
        return fileReservation;
    }

    public void setFileReservation(Collection<uReservationBean> fileReservation) {
